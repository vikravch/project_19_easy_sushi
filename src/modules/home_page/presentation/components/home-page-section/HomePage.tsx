...
const HomePage = () => {
    const imageUrls = [
      require('./../slideShow/imagesForCarousel/firstSlide.jpg'),
      require('./../slideShow/imagesForCarousel/secondSlide.jpg'),
      require('./../slideShow/imagesForCarousel/thirdSlide.jpg'),
    ];
